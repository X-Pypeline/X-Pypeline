# -*- coding: utf-8 -*-
#
# xpipeline documentation build configuration file, created by
...
project = u'xpipeline'
copyright = u'2018, Scott Coughlin'
...
version = xpipeline_version
# The full version, including alpha/beta/rc tags.
release = xpipeline_version
...
htmlhelp_basename = 'xpipelinedoc'
...
latex_documents = [
    (master_doc, 'xpipeline.tex', u'xpipeline Documentation',
...
man_pages = [
    (master_doc, 'xpipeline', u'xpipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xpipeline', u'xpipeline Documentation',
     author, 'Scott Coughlin', 'scott.coughlin@ligo.org',
     'Miscellaneous'),
]
